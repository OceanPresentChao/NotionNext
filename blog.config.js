...
const BLOG = {
  ...
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/d1e893d2a06d8320930181202354b6d6
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    'd1e893d2a06d8320930181202354b6d6',
  THEME: process.env.NEXT_PUBLIC_THEME || 'springslow', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.springslow.com', // 网站地址
